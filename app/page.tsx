...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-xl px-4 py-8 mt-auto mb-20">
      <h1 className="text-2xl font-bold text-center mb-6">AI Resume Tailor</h1>
