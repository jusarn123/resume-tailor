...
export const Nav = () => {
  return (
    <aside className="w-full bg-transparent z-50">
      <nav className="flex items-center justify-between px-0 sm:px-2 py-0">
        {/* Logo Left */}
        ...
        <h1 className="ml-6 text-2xl md:text-5xl font-extrabold tracking-tight text-white ml-4" style={{ fontFamily: 'Unbounded, sans-serif' }}>
          ResumeAI
        </h1>
