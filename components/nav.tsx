    ...
    <aside className="w-full bg-transparent z-50">
      <nav className="flex items-center justify-between px-0 sm:px-2 py-2">
        ...
        <Link href="/" aria-label="Home" className="flex items-center ml-6">
          <Image src="/logo2_opt.png" alt="Logo" width={30} height={30} className="object-contain w-6 md:w-8" />
          <h1 className="ml-4 text-2xl md:text-4xl font-extrabold tracking-tight text-white text-bottom" style={{ fontFamily: 'Unbounded, sans-serif' }}>
            ResumeAI
          </h1>
        </Link>
